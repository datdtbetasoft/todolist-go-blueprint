...
func (t *TaskController) CreateATaskByUser(title, description, state string, complete bool, startDate, dueDate string, userID int) (*models.Task, error) {
...
func (t *TaskController) UpdateATaskByUser(taskID int, title, description, state string, complete bool, startDate, dueDate string, userID int) (*models.Task, error) {
...
func (t *TaskController) DeleteATaskByUser(taskID int, userID int) error {
